...
import uz.urinov.comunicationsystem.entity.Packet;
import uz.urinov.comunicationsystem.payload.response.PacketType;
import uz.urinov.comunicationsystem.entity.Tariff;
import uz.urinov.comunicationsystem.entity.UssdCode;
import uz.urinov.comunicationsystem.payload.request.PacketDTO;
import uz.urinov.comunicationsystem.repository.PacketRepository;
import uz.urinov.comunicationsystem.repository.TariffRepository;
import uz.urinov.comunicationsystem.repository.UssdCodeRepository;

import java.util.*;

import static org.springframework.http.HttpStatus.*;
import static org.springframework.http.ResponseEntity.*;
import static uz.urinov.comunicationsystem.entity.enums.PacketType.*;
...
public class PacketService {
    ...
    private Map<Integer, uz.urinov.comunicationsystem.entity.enums.PacketType> types = new HashMap<>();
